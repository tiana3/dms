	...
	<div class="Hui-article">
		<article class="cl pd-20">
            ...
            <div align="center">
				...
				<tr>
				<td>编号</td><td><input type="text" value=<%=e.getEmployeeId() %> disabled="disabled">
				<%HttpSession ssion = request.getSession();
				ssion.setAttribute("empid", e.getEmployeeId());%></td>
				</tr>
				<tr>
				<td>员工名称:</td><td><input type="text" value=<%=e.getEmployeeName()%> name="name"></td>
				</tr>
				<tr>
				<td>性别:</td><td><input type="text" value=<%=e.getGender() %> name="gender"></td>
				</tr>
				<tr>
				<td>联系电话:</td><td><input type="text" value=<%=e.getPhone() %> name="phone"></td>
				</tr>
				<tr>
				<td> 身份证:</td><td><input type="text" value=<%=e.getIdCard() %> name="idcard"></td>
				</tr>
				<tr>
				<td>所属部门:</td><td><input type="text" value=<%=e.getDepartmentName()%> name="departmentname"></td>
				</tr>
				<tr>
				<td>工作岗位:</td>
				<td><input type="text" value=<%=e.getJobName() %> name="jobname"></td>
				</tr>
				<%}
				}%>
				</table>
