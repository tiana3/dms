...
<table class="table table-border table-bordered table-bg table-sort">
		...
		<tr class="text-c">						
				<td>地&nbsp;&nbsp;&nbsp;址&nbsp;:</td><td><input type="text" name="address" value="${carType.address}" class="input-text" style="width:200px;"></td>
				<td>发动机号:</td><td><input type="text" name="engineNumber" value="${carType.engineNumber}" class="input-text" style="width:200px;"></td>
		</tr>
		...
		<tr class="text-c">						
				<td>电&nbsp;&nbsp;&nbsp;&nbsp;话:</td><td><input type="text" name="phone" value="${carType.phone}" class="input-text" style="width:200px;"></td>
				<td>颜&nbsp;&nbsp;&nbsp;&nbsp;色:</td><td><input type="text" name="color" value="${carType.color}" class="input-text" style="width:200px;"></td>
		</tr>
		
		
		<tr class="text-c">						
				<td>身&nbsp;份&nbsp;证&nbsp;:</td><td><input type="text" name="idCard" value="${carType.idCard}" class="input-text" style="width:200px;"></td>
				<td>变&nbsp;速&nbsp;箱&nbsp;:</td><td><input type="text" name="gearBox" value="${carType.VIN}" class="input-text" style="width:200px;"></td>
		</tr>
		
	
		<tr class="text-c">						
				<td colspan="4"><button onClick="close()" class="btn btn-secondary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
